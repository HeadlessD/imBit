...
//    self.navigationBar.translucent = YES;
    ...
    UIImage *backIndicatorImage = DFImage(@"navigationbar_back_arrow");
//    navigationbar_back_arrow
//    dfarrow
    //dkq
...
- (void)configDefaultImageName {
    ...
    self.photoSelImageName = @"df_pic_select";
    self.photoDefImageName = @"df_pic_normal";
    self.photoNumberIconImageName = @"df_select_num";
    self.photoOriginDefImageName = @"df_full_normal";
    self.photoOriginSelImageName = @"df_full_select";
}
...
{
    [self showAlertWithTitle:title cancelTitle:nil message:message complete:complete];
}
...
{
    //    [BiChatGlobal showSuccessWithString:title];
    [BiChatGlobal showFailWithString:title];
