...
#import "ShareViewControllerVC.h"
#import "ShareActViewControllerVC.h"

@interface ShareViewControllerVC ()

@end

@implementation ShareViewControllerVC
...
- (void)didSelectPost{
    ...
    __weak ShareViewControllerVC *theController = self;
...
- (NSArray *)configurationItems {
    ...
    if (isPublic)
    {
        ...
        actItem.tapHandler = ^{
            ...
            //设置分享权限时弹出选择界面
            ShareActViewControllerVC *actVC = [[ShareActViewControllerVC alloc] init];
