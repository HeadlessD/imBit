//
//  CustomShareViewControllerEnt.m
//  ShareExtensionDemo
//
...
#import "CustomShareViewControllerEnt.h"

@interface CustomShareViewControllerEnt ()<UIWebViewDelegate>
...
@implementation CustomShareViewControllerEnt
                ...
                [itemProvider loadItemForTypeIdentifier:@"public.image" options:nil completionHandler:^(UIImage *image, NSError *error) {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        if (self.imagesArr.count == obj.attachments.count) {
                            ...
                            NSString *customURL = [NSString stringWithFormat:@"openimchatEnt://%@",_typeStr] ;
