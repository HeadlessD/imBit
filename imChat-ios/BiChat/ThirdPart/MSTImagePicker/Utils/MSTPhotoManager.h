...
/**
 ...
 @param completionBlock 回调
 */
- (void)getPickingImageFromPHAsset:(PHAsset *)asset isFullImage:(BOOL)isFullImage maxImageWidth:(CGFloat)width completionBlock:(void(^)(UIImage *image, UIImage *orignalImage, NSDictionary *info))completionBlock;
