...
//  BiChat
//
//  Created by imac2 on 2018/12/20.
//  Copyright © 2018 worm_kc. All rights reserved.
//

#import "FillMoneyCell.h"
#import "JSONkit.h"

@implementation FillMoneyCell
            ...
            resendAction:(SEL)resendAction
{
    ...
    label4Hint.layer.borderColor = [UIColor clearColor].CGColor;
    ...
    NSInteger len = [LLSTR(@"203110") length];
    [str addAttribute:NSForegroundColorAttributeName value:THEME_DARKBLUE range:NSMakeRange(str.length - len, len)];
