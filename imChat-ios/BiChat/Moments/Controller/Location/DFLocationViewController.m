...
@interface DFLocationViewController ()<UISearchControllerDelegate,UISearchResultsUpdating,MAMapViewDelegate,AMapLocationManagerDelegate,AMapSearchDelegate,UITableViewDelegate,UITableViewDataSource>
...
-(void)saveLocation{
    ...
    if (_delegage && [_delegage respondsToSelector:@selector(saveLocationWithAMapPOI:)]) {
        [_delegage saveLocationWithAMapPOI:self.currentPOI];
    }
...
- (void)setUpSearchController{
    ...
    bar.frame = CGRectMake(0, 64 + IPX_TOP_SAFE_H, SCREEN_WIDTH, 44);
...
- (UITableView *)tableView{
    if (_tableView == nil) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.searchController.searchBar.frame), SCREEN_WIDTH, SCREEN_HEIGHT) style:UITableViewStylePlain];
...
//    self.mapView.frame = CGRectMake(0, 64, SCREEN_WIDTH, 300);
    self.tableView.frame = CGRectMake(self.tableView.mj_x, self.tableView.mj_y - 35, SCREEN_WIDTH, self.tableView.mj_h);
        //    NSLog(@"ss---%@",NSStringFromCGRect(self.tableView.frame));
    
}

- (void)didDismissSearchController:(UISearchController *)searchController{
    self.searchController.searchBar.frame = CGRectMake(0, 64 + IPX_TOP_SAFE_H, SCREEN_WIDTH, 44);
//    self.mapView.frame = CGRectMake(0, 64 + 44, SCREEN_WIDTH, 300);
    self.tableView.frame = CGRectMake(0, CGRectGetMaxY(self.searchController.searchBar.frame), SCREEN_WIDTH, SCREEN_HEIGHT);
