//
//  ChatListFoldFriendViewController.m
//  BiChat
//
...
@interface ChatListFoldFriendViewController ()

@end

@implementation ChatListFoldFriendViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = LLSTR(@"101122");
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self refreshGUI];
    [BiChatGlobal sharedManager].FOLDFriendChatList = self;
}

- (void)viewDidDisappear:(BOOL)animated
{
    [super viewDidDisappear:animated];
    [BiChatGlobal sharedManager].FOLDFriendChatList = nil;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!muted || [[item objectForKey:@"newMessageCount"]integerValue] == 0)
        ...
        label4LastMessage.text = [LLSTR(@"101146") llReplaceWithArray:@[
                                  [NSString stringWithFormat:@"%@",[item objectForKey:@"newMessageCount"]],
                                  [item objectForKey:@"lastMessage"]]];
