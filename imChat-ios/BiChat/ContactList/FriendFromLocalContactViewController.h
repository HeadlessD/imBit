//
//  FriendFromLocalContactViewController.h
//  BiChat
//
...
@interface FriendFromLocalContactViewController : UIViewController<UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, MFMessageComposeViewControllerDelegate, addFriendDelegate, SCTableViewSectionIndexDelegate>
{
    //界面相关
    ...
    NSMutableArray *array4MakeFriend;
    NSMutableArray *array4NewAddFriend;
}
