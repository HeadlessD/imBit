...
#import "ShareViewControllerEnt.h"
#import "ShareActViewControllerEnt.h"

@interface ShareViewControllerEnt ()

@end

@implementation ShareViewControllerEnt
...
- (void)didSelectPost{
    ...
    __weak ShareViewControllerEnt *theController = self;
...
- (NSArray *)configurationItems {
    ...
    if (isPublic)
    {
        ...
        actItem.tapHandler = ^{
            ...
            //设置分享权限时弹出选择界面
            ShareActViewControllerEnt *actVC = [[ShareActViewControllerEnt alloc] init];
