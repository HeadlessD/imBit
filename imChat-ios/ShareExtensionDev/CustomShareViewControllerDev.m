//
//  CustomShareViewControllerDev.m
//  ShareExtensionDemo
//
...
#import "CustomShareViewControllerDev.h"

@interface CustomShareViewControllerDev ()<UIWebViewDelegate>
...
@implementation CustomShareViewControllerDev
                ...
                [itemProvider loadItemForTypeIdentifier:@"public.image" options:nil completionHandler:^(UIImage *image, NSError *error) {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        if (self.imagesArr.count == obj.attachments.count) {
                            ...
                            NSString *customURL = [NSString stringWithFormat:@"openimchatDev://%@",_typeStr] ;
