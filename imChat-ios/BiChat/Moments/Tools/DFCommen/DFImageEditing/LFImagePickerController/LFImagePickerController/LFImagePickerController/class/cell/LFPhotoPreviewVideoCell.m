...
- (void)didPauseCell
{
    if (self.model.type == LFAssetMediaTypeVideo) { /** 视频处理 */
        [_player pause];
        [_playButton setImage:DFImage(@"MMVideoPreviewPlay") forState:UIControlStateNormal];
        _isPlaying = NO;
    }
}
...
- (void)configPlayButton {
    ...
    [_playButton setImage:DFImage(@"MMVideoPreviewPlay") forState:UIControlStateNormal];
    [_playButton setImage:DFImage(@"MMVideoPreviewPlayHL") forState:UIControlStateHighlighted];
