//
//  ChargeGroupOfficialUserViewController.h
//  BiChat
//
...
@interface ChargeGroupOfficialUserViewController : UIViewController<UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource, SCTableViewSectionIndexDelegate>
{
