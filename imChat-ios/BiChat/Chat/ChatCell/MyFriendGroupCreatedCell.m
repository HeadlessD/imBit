...
#import "MyFriendGroupCreatedCell.h"

@implementation MyFriendGroupCreatedCell
            ...
            resendAction:(SEL)resendAction
{
    ...
    label4Hint.textColor = THEME_RED;
    ...
    [str addAttribute:NSForegroundColorAttributeName value:THEME_DARKBLUE range:NSMakeRange(str.length - LLSTR(@"203106").length, LLSTR(@"203106").length)];
