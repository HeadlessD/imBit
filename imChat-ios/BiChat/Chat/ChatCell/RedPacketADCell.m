...
#import "RedPacketADCell.h"

@implementation RedPacketADCell
            ...
            resendAction:(SEL)resendAction
{
    ...
    [str addAttribute:NSForegroundColorAttributeName value:THEME_DARKBLUE range:NSMakeRange(0, LLSTR(@"203104").length)];
