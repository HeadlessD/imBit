...
#import "CustomShareViewControllerCn.h"

@interface CustomShareViewControllerCn ()<UIWebViewDelegate>
...
@implementation CustomShareViewControllerCn
                ...
                [itemProvider loadItemForTypeIdentifier:@"public.image" options:nil completionHandler:^(UIImage *image, NSError *error) {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        if (self.imagesArr.count == obj.attachments.count) {
                            ...
                            NSString *customURL = [NSString stringWithFormat:@"openimchatCn://%@",_typeStr] ;
